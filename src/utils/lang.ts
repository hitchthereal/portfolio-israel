...
export const pt = {
  ...
  about: {
    ...
    description: "4 anos construindo sistemas web SaaS e plataformas White Label com React, Next.js, TypeScript, Node.js (Express) e Prisma. Experiência multiplataforma com Java, Spring Boot e Angular em ecossistemas corporativos. Cofundador de laboratório de software — lidero estratégia técnica, padrões de front-end e ciclos de entrega via Git/Bitbucket.",
...
export const en = {
  ...
  about: {
    ...
    description: "4 years building SaaS web systems and White Label platforms with React, Next.js, TypeScript, Node.js (Express) and Prisma. Cross-platform experience with Java, Spring Boot and Angular across enterprise ecosystems. Co-founder of a software lab — leading technical strategy, front-end standards and delivery cycles via Git/Bitbucket.",
    hireButton: "Hire me",
...
export type ILanguage = typeof pt